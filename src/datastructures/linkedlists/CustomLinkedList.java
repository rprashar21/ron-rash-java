...
public class CustomLinkedList {
    ...
    // linkedlist in java is double linked list that the list has reference to the first and last element
    // we use linked list so that opertaion in the midlle of any list is faster to do
